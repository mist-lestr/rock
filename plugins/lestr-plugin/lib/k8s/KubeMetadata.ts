...
import type { KubeManagedFieldsEntry, KubeOwnerReference, StringDict } from './KubeManagedFields';
 ...
 */
export interface KubeMetadataCreate extends Omit<KubeMetadata, 'uid' | 'creationTimestamp'> {
  /**
   * UID is the unique in time and space value for this object. It is typically generated by
   * the server on successful creation of a resource and is not allowed to change on PUT
   * operations. Populated by the system. Read-only.
