        ...
        style={
          {
            ...
            "--sidebar-offset-top": `calc(var(--spacing) * 16)`,
            ...style,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-[calc(100-var(--sidebar-offset-top))] top-(--sidebar-offset-top) w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
